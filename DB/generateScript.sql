...
CREATE TABLE IF NOT EXISTS `mydb`.`TB_PLAYER` (
  ...
  `TB_POSITION_cod_pos` VARCHAR(3) NOT NULL,
  PRIMARY KEY (`id_player`, `TB_POSITION_cod_pos`),
  INDEX `fk_TB_PLAYER_TB_R_CLUB1_idx` (`id_club` ASC),
  INDEX `fk_TB_PLAYER_TB_POSITION1_idx` (`TB_POSITION_cod_pos` ASC),
  ...
  CONSTRAINT `fk_TB_PLAYER_TB_POSITION1`
    FOREIGN KEY (`TB_POSITION_cod_pos`)
