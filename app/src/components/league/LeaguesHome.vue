<template>
  <div class="q-pa-lg row items-start justify-center">
    <q-card class="col-12" style="max-width: 800px">
      ...
      <q-card-section>
        <q-list bordered class="q-my-md" separator>
          <q-item v-for="i in myleagues" :key="i['id_league']" clickable :to="`/leagues/manage/${i['id_league']}`">
    ...
    <q-card class="col-12 q-mt-md" style="max-width: 800px">
      ...
      <q-card-section>
        <q-list bordered class="q-my-md" separator>
          <q-item v-for="i in allLeagues" :key="i['id_league']" clickable :to="`/leagues/manage/${i['id_league']}`">
            <q-item-section avatar>
              <badge height="50px"/>
            </q-item-section>
            <q-item-section>
...
export default {
  ...
  data: () => ({
    myleagues: [
      { 'id_league': 1, 'name': 'Liga da BOA' },
      { 'id_league': 2, 'name': 'Liga da BOA' }
    ],
    allLeagues: [
      { 'id_league': 1, 'name': 'Liga da BOA' },
      { 'id_league': 2, 'name': 'Liga da BOA' }
