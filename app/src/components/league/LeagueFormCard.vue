<template>
  <q-card>
    <q-card-section class="bg-secondary card-title text-uppercase text-white">Modificar Liga</q-card-section>
    <q-card-section>
    ...
    <q-card-actions vertical align="center">
      <q-btn color="secondary" @click="$emit('save', aLeague)">Salvar</q-btn>
    </q-card-actions>
  </q-card>
</template>
<script>
